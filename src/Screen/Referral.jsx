...
const Referral = () => {
  ...
  <div className="flex flex-col ">
    <small className="text-lg .subpixel-antialiased  mx-6  my-2 font-bold ">How do you recieve your income ?</small>
    <small className="text-lg .subpixel-antialiased   mx-6 my-3 ">Do You have a referral code  ?</small>


    <div>
            <input type="text" id="first_name"   class="mx-6 w-5/6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter Referral Code " required>
            </input>
